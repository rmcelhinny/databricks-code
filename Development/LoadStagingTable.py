...
# MAGIC #storageAccount01 = dbutils.secrets.get(scope = "bricksFiles", key = "storageAccount01")
# MAGIC #BlobKey = dbutils.secrets.get(scope = "BlobAccount", key = "BlobAccessKey")
# MAGIC 
# MAGIC #connection_string =f"DefaultEndpointsProtocol=https;AccountName={AccountName};AccountKey=;EndpointSuffix=core.windows.net"
# MAGIC 
...
#Add later for other data type values other than BigInt when needed
for value in range(0,MaxOrdinalPosition):
